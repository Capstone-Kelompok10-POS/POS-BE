...
// CheckTransactionStatus provides a mock function with given fields: invoice
func (_m *MidtransCoreApi) CheckTransactionStatus(invoice string) (string, *domain.PaymentTransactionStatus, error) {
